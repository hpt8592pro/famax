...
(function ($) {
	...
	var getPagePosts = function ($famaxContainer,nextPageApiUrl) {
		...
		if(null==nextPageApiUrl) {
			apiUrl = "https://graph.facebook.com/v2.4/"+famax_global_options.fanPageId+"/posts?limit="+famax_global_options.maxResults+"&access_token="+famax_global_options.accessToken+"&fields=type,message,object_id,picture,name,description,link,from,comments.limit(1).summary(true),likes.limit(1).summary(true),shares";
		} else {
